...
const fs = require('fs');
const { abi } = JSON.parse(fs.readFileSync('IERC20.json'));
...
async function main() {
  ...
  const tx = {
    ...
    to: '0xcf8adb5acd96469361645adc7cceebf2bdcced68',
    // Encoded data payload representing the contract method call
    data: iface.encodeFunctionData('transfer', ['0xE6b48d76Bc4805ABF61F38A55F1D7C362c8BfdA8', 20000000]),
